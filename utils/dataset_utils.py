...
from server.Wav2vec_model.utils.preprocessing.make_data_list import make_data_list, make_trainlist
from server.Wav2vec_model.utils.preprocessing.read_audio import with_soundfile
from server.Wav2vec_model.models.wav2vec2 import FeatureExtract
...
class TrainSet(Dataset):
    def __init__(self, path, type="flac", suffle=True):
        ...
        for i in self.datalist:
            ...
            input = torch.from_numpy(input).float().unsqueeze(0).to("cpu")
