from server.Wav2vec_model.utils.model.conv1d_list import *
from server.Wav2vec_model.utils.model.conv1d_seq import *
import torch
...
class Model1(nn.Module):
    def __init__(self, feature_dim, num_layer=3, conv_hidden_dim=512, out_dim=115, dr_rate=3):
        ...
        self.conv_layer = Conv1d_list(
            num_layer, conv_hidden_dim, conv_hidden_dim)
...
class Model2(nn.Module):
    def __init__(self, feature_dim, conv_hidden_dim=512, out_dim=115, dr_rate=30):
        ...
        self.conv_layer = nn.ModuleList([
            Conv1d_seq_Batch_Avg(
                in_channel=feature_dim, out_channel=feature_dim, padding="same", padding_mode="circular"),
            Conv1d_seq_Batch_Avg(
                in_channel=feature_dim, out_channel=conv_hidden_dim, padding="same", padding_mode="circular"),
            Conv1d_seq_Batch_Avg(
                in_channel=conv_hidden_dim, out_channel=conv_hidden_dim, padding="same", padding_mode="circular"),
            Conv1d_seq_Batch_Avg(
                in_channel=conv_hidden_dim, out_channel=feature_dim, padding="same", padding_mode="circular"),
        ])
...
class Model3(nn.Module):
    def __init__(self, feature_dim, conv_hidden_dim=512, out_dim=115, dr_rate=30):
        ...
        self.pre_conv = Conv1d_seq(
            in_channel=feature_dim, out_channel=conv_hidden_dim, padding="same")
        self.conv_layer = Conv1d_list_Batch_Avg(
            num_layer=3, in_channel=conv_hidden_dim, out_channel=conv_hidden_dim, padding="same", drop_rate=0.4)
